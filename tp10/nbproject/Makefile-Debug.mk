...
${OBJECTDIR}/ports.o: ports.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ports.o ports.c
...
${OBJECTDIR}/ports_nomain.o: ${OBJECTDIR}/ports.o ports.c 
	${MKDIR} -p ${OBJECTDIR}
	@NMOUTPUT=`${NM} ${OBJECTDIR}/ports.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ports_nomain.o ports.c;\
	else  \
	    ${CP} ${OBJECTDIR}/ports.o ${OBJECTDIR}/ports_nomain.o;\
	fi
